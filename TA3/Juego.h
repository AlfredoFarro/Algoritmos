...
bool ColisionDistancia(int obj1X, int obj1Y, int obj1A, int obj1L, int obj2X, int obj2Y, int obj2A, int obj2L, int dist)
{
...
bool ColisionUsando_BoundingBox(int obj1X, int obj1Y, int obj1A,
...
public:
	Juego(int _DW, int _DH, int N_A, int N_Ag, int N_Hab);
	~Juego();
...
Juego::Juego(int _DW, int _DH, int N_A, int N_Ag, int N_Hab)
{
	DW = _DW;
	DH = _DH;
	NumA = N_A;
...
void Juego::MoverLider(Graphics^ canvas, Direccion Teclapulsada)
{
	ObjetoLider->mover(canvas, Teclapulsada, DW, DH);
	if (objeto_casa->retornar_Alterado() == true)
	{
		if (ColisionDistancia(ObjetoLider->retornarX(), ObjetoLider->retornarY(), ObjetoLider->retornarW(), ObjetoLider->retornarH(), objeto_casa->retornarX(),
			objeto_casa->retornarY(), objeto_casa->retornarw(), objeto_casa->retornarh(), 50))
		{
			if (ObjetoLider->retornar_ten_cosas() == true)
			{
				objeto_casa->CambiarImagen("Imagenes/casa.png");
	...
	{
		if (ColisionDistancia(ObjetoLider->retornarX(), ObjetoLider->retornarY(), ObjetoLider->retornarW(), ObjetoLider->retornarH(), objeto_camion->retornarX(),
...
void Juego::Cam_Dir_Lider(Direccion Teclapulsada)
{
	ObjetoLider->cambiar_dx_dy(Teclapulsada);
}

void Juego::mostrar_casa(Graphics^ canvas)
{
	objeto_casa->mostrar(canvas);
}
void Juego::Cambiar_e_casa(bool dato)
{
	objeto_casa->CambiarImagen("Imagenes/casaA.png");
	objeto_casa->cam_alt(dato);
}
bool Juego::retornar_e_casa()
{
	return objeto_casa->retornar_Alterado();
}
void Juego::mostrar_camion(Graphics^ canvas)
{
	objeto_camion->mostrar(canvas);
}
void Juego::cambiar_e_camion(bool dato)
{
	objeto_camion->CambiarImagen("Imagenes/camionA.png");
	objeto_camion->cam_Alt(dato);
}
bool Juego::retornar_e_camion()
{
...
void Juego::MoverAliado(Graphics^ canvas)
{
	if (objeto_Vec_Aliado->get_N() > 0)
	{
		...
		{
			ObjetoAliado = objeto_Vec_Aliado->get(i);
			if (ColisionUsando_BoundingBox(ObjetoAliado->retornarX(), ObjetoAliado->retornarY(), ObjetoAliado->retornarW(), ObjetoAliado->retornarH(), objeto_casa->retornarX(),
				objeto_casa->retornarY(), objeto_casa->retornarw(), objeto_casa->retornarh()) || ColisionUsando_BoundingBox(ObjetoAliado->retornarX(), ObjetoAliado->retornarY(), ObjetoAliado->retornarW(), ObjetoAliado->retornarH(), objeto_camion->retornarX(),
...
void Juego::MoverAgente(Graphics^ canvas)
{
	if (objeto_Vec_Agente->get_N() > 0)
	{
		...
		{
			ObjetoAgente = objeto_Vec_Agente->get(i);
			if (ColisionDistancia(ObjetoAgente->retornarX(), ObjetoAgente->retornarY(), ObjetoAgente->retornarW(), ObjetoAgente->retornarH(), ObjetoLider->retornarX(),
			...
			if (ColisionUsando_BoundingBox(ObjetoAgente->retornarX(), ObjetoAgente->retornarY(), ObjetoAgente->retornarW(), ObjetoAgente->retornarH(), objeto_casa->retornarX(),
				objeto_casa->retornarY(), objeto_casa->retornarw(), objeto_casa->retornarh()) || ColisionUsando_BoundingBox(ObjetoAgente->retornarX(), ObjetoAgente->retornarY(), ObjetoAgente->retornarW(), ObjetoAgente->retornarH(), objeto_camion->retornarX(),
...
void Juego::MoverHabitante(Graphics^ canvas)
{
	if (objeto_Vec_Habitantes->get_N() > 0)
	{
		for (int i = 0; i < objeto_Vec_Habitantes->get_N(); i++)
		{
			...
			if (ColisionUsando_BoundingBox(ObjetoHabitante->retornarX(), ObjetoHabitante->retornarY(), ObjetoHabitante->retornarW(), ObjetoHabitante->retornarH(), objeto_casa->retornarX(),
				objeto_casa->retornarY(), objeto_casa->retornarw(), objeto_casa->retornarh()) || ColisionUsando_BoundingBox(ObjetoHabitante->retornarX(), ObjetoHabitante->retornarY(), ObjetoHabitante->retornarW(), ObjetoHabitante->retornarH(), objeto_camion->retornarX(),
					objeto_camion->retornarX(), objeto_camion->retornarw(), objeto_camion->retornarh()))
			{
